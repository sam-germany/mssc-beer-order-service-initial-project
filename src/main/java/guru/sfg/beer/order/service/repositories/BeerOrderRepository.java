...
Note: when we use a @lock then at a time only one thread can obtain a Lock,


@Lock()  <-- with this we can ensure that only the defined operation can be done by this method

their are three type we can define
